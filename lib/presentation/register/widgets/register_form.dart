...
import 'package:icecream_todo/presentation/core/utils/size_config.dart';
...
class _RegisterFormState extends State<RegisterForm> {
        ...
        state.authFailOrSuccess.fold(
          ...
          (either) => either.fold(
            (failure) => failure.maybeMap(
              ...
              emailExisted: (msg) {
                showError(context, LocaleKeys.email_existed.tr());
              },
              orElse: () {
                showError(context, LocaleKeys.some_thing_wrong.tr());
              },
            ),
            (r) {
  ...
  Widget _getBody(BuildContext context, RegisterFormState state) {
    return Stack(
      children: [
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  PasswordField(
                    onChanged: (text) => context.read<RegisterFormBloc>().add(
